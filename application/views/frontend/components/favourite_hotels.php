<div class="popular-hotels my-4">

	<h4>Favourited Hotels</h4>

	<div class="row pl-2">

		<?php if ( !empty( $favourited_hotels )): foreach ( $favourited_hotels as $hotel ): ?>
...
function favourited_hotels()
{
	...
	$('.loadMoreHotels').click(function(){
		...
		$.ajax({
			type: 'POST',
			url: userUrl + '/loadmore_favourited_hotels',
	...
	function loadRatings()
	{
		...
		<?php if ( !isset( $favourited_hotels[$i] )) continue; ?>

		<?php $hotel = $favourited_hotels[$i];?>
