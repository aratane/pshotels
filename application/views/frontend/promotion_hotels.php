...
<div class="container pt-3 pb-5">
	<div class="popular-hotels mb-4">
		...
		<p class="lead">
			<?php echo get_msg( 'promotion_hotel_slogan' ); ?>
		</p>

		<div class="row pl-2">

			<?php if ( !empty( $promotion_hotels )): foreach ( $promotion_hotels as $hotel ): ?>
...
<div class="col-12 mb-1 col-md-4 padding-0 hotelToClone d-none">
	<div class="card">
		...
		<span class="ps-top-badge badge badge-success hotel__promotion"></span>
...
function promotion_hotels()
{
	...
	$('.loadMoreHotels').click(function(){
		...
		$.ajax({
			type: 'POST',
			url: ajaxUrl + '/loadmore_promotion_hotels',
	...
	function appendHotels( hotel )
	{
		...
		if ( hotel.promotion != null ) {
			hotelClone.find('.hotel__promotion').html( hotel.promotion.promo_percent + "% Promotion!" );
		} else {
			hotelClone.find('.hotel__promotion').remove();
		}
